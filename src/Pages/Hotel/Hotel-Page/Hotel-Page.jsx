...
<Head2
      ...
      <div className="statistics">
        <Statistics1
          ...
          px1={2020} px2={2021} px3={2022} px4={2023} px5={2024} px6={2025}
        />
        <Statistics2
          value1={400} value2={200} value3={300} value4={500}
          label1={"Group A"} label2={"Group B"} label3={"Group C"} label4={"Group D"}
        />
        <Statistics3
          a1={2} a2={3} a3={4} a4={1} a5={2}
          b1={4} b2={4} b3={2} b4={1} b5={2}
          c1={5} c2={6} c3={3} c4={7} c5={1}
        />
        <Statistics4
